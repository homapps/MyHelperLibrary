package com.homapps.helperlibrary
...
class SearchView(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    var isSearchOpened : ((Boolean) -> Unit)? = null
    ...
    private fun closeSearch() {
        ...
        circularConceal.addListener(object :
